...
const expectArrayEquivalence = <M>(actual: DeeplyAllowMatchers<M>[], expected: DeeplyAllowMatchers<M>[]) => {
...
describe('merging', () => {
    test('', () => {
        ...
        expectArrayEquivalence(merger.getMostFrequentLocations(), [locationAAA, locationB]);
    });
    test('highly necessary test', () => {
        ...
        merger.addLocation(locationA);
        merger.addLocation(locationB);
        expectArrayEquivalence(merger.getMostFrequentLocations(), [locationA, locationB]);
    });
});
